...
import 'package:bloc_firestore_todos/blocs/filtered_todos/filtered_todos_bloc.dart';
import 'package:bloc_firestore_todos/blocs/filtered_todos/filtered_todos_state.dart';
    ...
    return PopupMenuButton<VisibilityFilter>(
      ...
      itemBuilder: (BuildContext context) => <PopupMenuItem<VisibilityFilter>>[
        ...
        PopupMenuItem<VisibilityFilter>(
          ...
          value: VisibilityFilter.inCompleted,
          child: Text(
            ArchSampleLocalizations.of(context).showActive,
            style: activeFilter == VisibilityFilter.inCompleted
                ? activeStyle
                : defaultStyle,
          ),
        ),
